...
Filmdex is a movie database web application that allows users to view, sort, and search for movies in a database. It has a search bar, that shows live search results, as well as a Favorites List that allows users to add their favorite films without logging in.
...
* A special thanks to Michael for helping us through building this app, even coming to help after school hours. We are so grateful!
